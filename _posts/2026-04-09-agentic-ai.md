...
1. **Goal definition** — the system understands what success looks like.
2. **Task planning** — it creates a sequence of actions or subtasks.
3. **Action execution and feedback** — it performs steps, evaluates results, and adjusts the plan.
